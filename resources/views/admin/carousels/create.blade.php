...
@section('content')
    <div class="pt-3 max-w-8xl">
        ...
        <form action="{{ route('carousels.store') }}" method="POST" id="carouselForm"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Judul Slide <span
                ...
                <div class="flex items-center gap-3 pt-8">
                    ...
                    <input type="checkbox" name="is_active" value="1" id="is_active" checked class="w-5 h-5 text-[#48c3d9]">
                    <label for="is_active" class="text-gray-700 font-medium">Aktifkan slide ini</label>
                </div>

                <!-- Gambar dengan Crop -->
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-3">Gambar Carousel <span
                            class="text-red-500">*</span></label>
                    ...
                    <div onclick="document.getElementById('imageInput').click()"
                        ...
                        <p class="text-xs text-gray-400 mt-1">Direkomendasikan ukuran 1900 × 815 px</p>
                    </div>
                    ...
                    <div id="previewContainer" class="mt-6 hidden">
                        <p class="text-xs text-gray-500 mb-2">Gambar yang akan digunakan:</p>
                        <img id="preview" class="max-h-80 rounded-2xl shadow border border-gray-200" alt="Preview">
                    </div>
                </div>
            ...
            <div class="mt-12 flex justify-end">
                <button type="submit"
                    class="bg-[#48c3d9] hover:bg-[#3ab5cc] text-white font-semibold px-10 py-4 rounded-2xl flex items-center gap-3">
