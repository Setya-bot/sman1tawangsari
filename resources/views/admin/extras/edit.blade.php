...
<div class="content-wrapper-card">
    <form action="{{ route('extras.update', $extra->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                <h5 class="text-primary fw-semibold border-bottom pb-2">Edit Ekstrakurikuler</h5>
            </div>
            ...
            <div class="col-12">
                ...
                <textarea name="description" class="form-control" rows="4">{{ $extra->description }}</textarea>
            </div>
