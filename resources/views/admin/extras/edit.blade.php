...
<div class="pt-3 max-w-8xl mx-auto">
    ...
    <form action="{{ route('extras.update', $extra->id) }}" method="POST" enctype="multipart/form-data" 
          id="extraForm" class="bg-white rounded-3xl shadow border border-gray-100 p-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div id="previewContainer" class="mt-6">
                    ...
                    <div class="flex justify-center">
                        <div class="border border-gray-200 rounded-2xl p-4 bg-gray-50 shadow-sm">
                            <img id="preview" 
                                 src="{{ $extra->image ? asset('storage/'.$extra->image) : asset('images/no-image.png') }}"
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" rows="6" 
                    ...
                    placeholder="Deskripsikan kegiatan ekstrakurikuler ini...">{{ old('description', $extra->description) }}</textarea>
            </div>
