...
@section('title', $ekskul->name . ' - Ekskul')

@section('content')

    <div class="relative h-[65vh] flex items-center justify-center overflow-hidden">
        <div
            class="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1541339907198-e08756ebafe3?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center">
        </div>
        ...
        <div class="relative z-10 text-left px-6 max-w-7xl mx-auto w-full">
            <div class="max-w-3xl">
                <span
                    class="inline-block px-4 py-1.5 bg-[#48c3d9] text-gray-900 text-xs font-bold uppercase tracking-widest rounded-md mb-6 shadow-lg shadow-[#48c3d9]/20">
                    Ekskul
                </span>
                ...
                <p
                    class="text-lg md:text-xl text-white/80 font-light leading-relaxed border-l-4 border-[#48c3d9] pl-6 border-l-4 border-[#48c3d9] pl-6">
        ...
        <div class="grid lg:grid-cols-12 gap-12">
                ...
                <div class="mt-16 bg-white border border-gray-100 shadow-sm rounded-3xl p-8 md:p-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="flex gap-5">
                            <div
                                class="w-12 h-12 bg-[#48c3d9]/20 -50 text-[#48c3d9] rounded-2xl flex items-center justify-center flex-shrink-0 text-xl shadow-sm">
                                <i class="far fa-calendar-alt"></i>
                            </div>
                            <div>
                                <p class="font-bold text-gray-800 mb-1">Jadwal Latihan</p>
                                <p class="text-gray-500 leading-relaxed">Sesuai kesepakatan anggota & pembina (Umumnya 2x
                                    seminggu)</p>
                            </div>
                        </div>
                        <div class="flex gap-5">
            ...
            <div class="lg:col-span-4">
                <div class="sticky top-24 space-y-8">
                    ...
                    <div
                        class="bg-white border border-gray-100 rounded-[2rem] p-8 text-center shadow-xl shadow-gray-100/50">
                        <div
                            class="mx-auto w-32 h-32 bg-gray-50 rounded-[2rem] flex items-center justify-center shadow-inner mb-6 overflow-hidden border-4 border-white">
                            @if($ekskul->image)
                        ...
                        <div class="space-y-5 text-left text-sm">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <span
                                        class="text-[10px] uppercase font-bold text-gray-400 block tracking-widest">Pembina</span>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <span
                                        class="text-[10px] uppercase font-bold text-gray-400 block tracking-widest">Lokasi</span>
                    ...
                    <div class="bg-gray-900 rounded-[2rem] p-8 relative overflow-hidden group">
                        <div
                            class="absolute -right-10 -bottom-10 w-32 h-32 bg-emerald-500/20 rounded-full blur-3xl group-hover:bg-emerald-500/40 transition-all duration-700">
                        </div>
                        ...
                        <p class="text-gray-400 text-sm leading-relaxed mb-6 relative z-10">
                            Kembangkan potensimu bersama komunitas {{ $ekskul->name }}. Pendaftaran dibuka setiap awal
                            semester.
                        </p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($others as $item)
                        <div class="group relative">
                            <div
                                class="absolute inset-0 bg-[#48c3d9] rounded-[2.5rem] translate-x-2 translate-y-2 opacity-0 group-hover:opacity-100 transition-all duration-300 -z-10">
                            </div>
                            <a href="{{ route('ekskul.detail', $ekskul->id) }}"
                                ...
                                <div class="relative w-20 h-20 mb-8">
                                    <div
                                        class="absolute inset-0 bg-[#48c3d9]/10 rounded-2xl rotate-6 group-hover:rotate-12 transition-transform">
                                    </div>
                                    <div
                                        class="absolute inset-0 rounded-2xl flex items-center justify-center text-4xl shadow-lg shadow-[#48c3d9]/20">
                                ...
                                <p class="text-gray-500 leading-relaxed mb-8 text-sm italic">
                                    "{{ Str::limit($item->description, 110) ?? 'Lihat detail kegiatan dan program kerja untuk unit ini.' }}"
                                </p>
                                <div class="mt-6 flex items-center text-[#48c3d9] font-bold text-sm">
                                    Selengkapnya <i
                                        class="fas fa-arrow-right ml-2 text-xs transition-transform group-hover:translate-x-2"></i>
                                </div>
                            </a>
                        </div>
                    @endforeach
